...
\section{Publications / Working Papers}
  ...
  {\bf DiffCJK: Conditional Diffusion Model for High-Quality and Wide-coverage CJK Character Generation}
  \emph{Yingtao Tian}\\
  \emph{International Conference on Computational Creativity (ICCC) 2024}
